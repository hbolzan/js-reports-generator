...
// TODO: extend aggregators to receive also parent data to make some computation against all data

describe("sum", () => {
    const column = Column.parse({ name: "value", dataType: Number });
...
describe("concat", () => {
    const column = Column.parse({ name: "value" });
...
describe("count", () => {
    const column = Column.parse({ name: "item", dataType: Number });
